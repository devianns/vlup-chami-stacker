...
현재 게임 프로토콜은 v5, 콘텐츠 버전은 2.2.0입니다. v2.1에서는 한계선을 화면 기준 45px 위로 조정해 쌓기 공간을 약 6.9% 넓혔고, v2.2에서는 찌그러진 차미의 충돌체와 무게중심을 실제 몸통에 맞게 조정했습니다. 밀집도는 전체 유효 공간을 기준으로 정규화되므로 0~100% 기준은 유지됩니다.
